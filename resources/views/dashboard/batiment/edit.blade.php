<div class="modal fade" id="editBatimentModal{{$batiment->Num_Bat}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <form action="{{ route('dashboard.batiments.update' , 'test') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input id="name" type="text" name="name" value="{{ $batiment->bat_no }}" class="form-control">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="sup_SDHO" value="{{ $batiment->sup_SDHO }}">
                        </div>
