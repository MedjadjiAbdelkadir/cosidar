<div class="modal fade" id="editBienModal{{ $ilot->Num_ilot }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>Modifier un ilot</h4>
                <!-- add_form -->
                <form action="{{ route('dashboard.ilots.updated', $ilot->Num_ilot) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden"  name="id" id="idIlot" value="{{ $ilot->Num_ilot }}">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select  name="intit_Entretien" value="{{  $ilot->intit_Entretien  }}" required class="form-control">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="Nature" value="{{  $ilot->Nature  }}" id="" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="Rue_fr" id="" class="form-control" value="{{  $ilot->Rue_fr  }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="Int_VV"  class="form-control" value="{{  $ilot->Int_VV  }}" required>
                                ...
                                {{-- <ul class="options" style="background-color:white;height: 200px;overflow-y: scroll;">
                                    @foreach($pays as $paysInfo)
                                        <li data-value="{{ $paysInfo['name'] }}">
                                            <img src="{{ asset('public/flags/' . $paysInfo['flag_1x1']) }}" alt="{{ $paysInfo['name'] }}" class="flag-icon">
                                            {{ $paysInfo['name'] }}
                                        </li>
                                    @endforeach
                                </ul> --}}
                            </div>
                            <input type="hidden" name="Pays" id="pays" value="{{  $ilot->Pays  }}" value="">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="mr-sm-2">Evaluation locative</label>
                            <select name="Int_VL" class="form-control" value="{{  $ilot->Int_VL  }}" required>
                        ...
                        @if ($ilot->image  )
                            <img src="{{ asset( 'storage/'.$ilot->image) }}" alt="" width="80px"/>
                        @endif
                    </div>
                    <br><br>
            </div>
