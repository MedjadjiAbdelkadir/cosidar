<!-- Footer Start -->
<div style="background-color: #a1c4fd;" class="container-fluid  text-body footer mt-5 pt-5 px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a href="#">Cosidar</a>, All Right Reserved.
                </div>
